...
public class FileItemAdapter extends RecyclerView.Adapter<FileItemAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ViewHolder(fileItemView);
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.mTextFourthLine.setText("\uD83C\uDFC3\u200D♂️Φ " + String.format("%.0f", fileItem.getAvgAcceleration()) + "m/s2" + "\n"
            + "\uD83C\uDF10 Φ " + String.format("%.1f", fileItem.getAvgGyroscope()) + "rad/s" + "\n" + "\uD83E\uDDED Φ " + String.format("%.0f", fileItem.getAvgMagnetic()) +"μT");
    }
