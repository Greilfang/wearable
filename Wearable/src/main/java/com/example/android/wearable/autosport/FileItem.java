...
public class FileItem {
    ...
    private float avgGyroscope;
    private float avgMagnetic;
    ...
    public FileItem(File file) throws IOException {
        ...
        while (true) {
            ...
            switch (id) {
                ...
                case 0x1013: // avg step rate (float)
                    avgStepRate = BitUtility.getFloat(buffer, offset);
                    break;

                case 0x1014: // avg speed (float)
    ...
    /**
     * Gets an average acceleration in meters per second.
     *
     * @return the average acceleration in meters per second
     */
    ...
    /**
     * Gets an average rotation in rad per second.
     *
     * @return the average acceleration in rad per second
     */
    public float getAvgGyroscope() {
        return avgGyroscope;
    }

    /**
     * Gets an average acceleration in μT.
     *
     * @return the average acceleration in μT
     */
    public float getAvgMagnetic() {
        return avgMagnetic;
    }
}
